...
sc_string_raises_t sc_compile_c(sc_scope_t *table, uint64_t flags) {
    using namespace scopes;
    //SCOPES_RESULT_TYPE(const String *);
    return convert_result(compile_c(table, flags));
}
...
#define DEFINE_RAISING_EXTERN_C_FUNCTION(FUNC, RETTYPE, ...) \
    ...
    DEFINE_RAISING_EXTERN_C_FUNCTION(sc_compile_c, TYPE_String, TYPE_Scope, TYPE_U64);
